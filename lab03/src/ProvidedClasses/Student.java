...
public class Student 
{
    ...
    private Teacher teacher;   // The current Teacher for the student
    ...
    {
        return "Student: (Name: " + studentName + ", ID:" + studentID + ", Teacher: " + teacher + ", Grades: ["+ examScores[0] +", " + examScores[1] + ", " +examScores[2] +"])";
    } 
