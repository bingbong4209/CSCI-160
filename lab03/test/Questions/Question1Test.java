...
public class Question1Test
{
    ...
    public void testQuestion1_Part3_isCorrect()
    {
        ...
        assertEquals("This test fails if the incorrect Teacher object was assigned to student1", ((Student) results[2]).getTeacher(), (results[0]));
    }

    @Test
    public void testQuestion1_Part4_isCorrect()
    {
        assertEquals("This test fails if the incorrect Teacher object was assigned to student2", ((Student) results[3]).getTeacher(), (results[0]));
    }

    @Test
    public void testQuestion1_Part5_isCorrect()
    {
        assertEquals("This test fails if the incorrect Teacher object was assigned to student2", ((Student) results[4]).getTeacher(), (results[1]));
    }
