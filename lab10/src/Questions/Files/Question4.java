...
public class Question4 {
    ...
    public static void Question4() {
        try {
            PrintWriter file = new PrintWriter(new FileOutputStream("files/question4/MySecretsOfTheUniverse.txt", false));
            
            file.println("The meaning of life is 42");
            file.println("My mom is weird");
            file.println("China is the best");
            file.close();
