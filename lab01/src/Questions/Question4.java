...
public class Question4 {
    /**
     * For this portion of the assignment you will be working with String concatenation and
     *  escape sequences in addition to using the pre and postfix operators from incrementing
     *  and decrementing variables.
     * 
     * Four (4) variables have already been declared an initialized as part of this assignment. 
     *  You will be using these variables as part of your solution.
     * 
     * Each of the parts below will involve using String concatenation, escape sequences, and 
     *  one of the pre or postfix operators. 
     * 
